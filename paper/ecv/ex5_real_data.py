'''
This script applies ECV on real single-cell multi-modal data.
The script takes 2 command line arguments:
    - i_celltype: integer index of the cell type to use (0-5)
...
celltype = cell_types_list[i_celltype]
...
method = 'tree'
lam = None
path_result = 'result/ex5/{}/{}/{}/'.format(celltype,bagging,method)
